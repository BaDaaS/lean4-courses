...
```lean fromFile:Examples.lean#say_hello_macro
...
```lean fromFile:Examples.lean#custom_infix
...
```lean fromFile:Examples.lean#auto_tactic
...
```lean fromFile:Examples.lean#my_assumption_tactic
